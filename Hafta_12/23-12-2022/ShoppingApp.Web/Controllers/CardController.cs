...
namespace ShoppingApp.Web.Controllers
{
    ...
    public class CardController : Controller
    {
        ...
        private Payment PaymentProcess(OrderDto orderDto)
        {
            ...
            options.ApiKey = "sandbox-DX2CfN4SrKZ3UtQQ3ezneQeeyu0paTEU";
            options.SecretKey = "sandbox-POZm4459EIMPG8H76gsHAXPVKmVuj944";
        ...
        { 
            ...
            foreach (var order in orders)
            {
                orderListDto = new OrderListDto()
                {
                    ...
                    OrderListItems = order.OrderItems
                        .Select(oi => new OrderListItemDto
                        {
