...
namespace ShoppingApp.Data.Config
{
    public class ProductCategoryConfig : IEntityTypeConfiguration<ProductCategory>
    {
        public void Configure(EntityTypeBuilder<ProductCategory> builder)
        {
            ...
            // Burada ProductId ve CategoryId' den oluşan herbir satırın bir kez daha tekrar etmemesi için 
            ...
            builder.HasData
                ...
                new ProductCategory { ProductId = 7, CategoryId = 2 }, // 7 numaralı ürün hem 2. kategoride hemde 4. kategoride  
