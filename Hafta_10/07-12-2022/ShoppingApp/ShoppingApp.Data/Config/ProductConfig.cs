...
namespace ShoppingApp.Data.Config
{
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        ...
        {
            builder.HasKey(p => p.Id);// Id primary key oldu
            ...
            builder.Property(p => p.DateAdded).HasDefaultValueSql("date('now')"); // Sqlite için 
                                                                                  // builder.Property(p => p.DateAdded).HasDefaultValueSql("getdate()"); // Sql Server için 
