...
namespace BlogApp.Data.Migrations
{
    ...
    partial class BloggAppContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("BlogApp.Entities.Concrete.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(3169),
                            Date = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(3167),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreated",
                            ModifiedDate = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(3170),
                            Note = "C# yenilikleri.",
                        ...
                        new
                        {
                            ...
                            CreatedByName = "InitialCreated",
                            CreatedDate = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(3177),
                            Date = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(3176),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreated",
                            ModifiedDate = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(3178),
                        ...
                        new
                        {
                            ...
                            CreatedByName = "InitialCreated",
                            CreatedDate = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(3184),
                            Date = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(3182),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreated",
                            ModifiedDate = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(3185),
            ...
            modelBuilder.Entity("BlogApp.Entities.Concrete.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedByName = "InitialCreated",
                            CreatedDate = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(5039),
                            Description = "C# programlama ile ilgili makaleler.",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreated",
                            ModifiedDate = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(5041),
                            Name = "C#",
                        ...
                        new
                        {
                            Id = 2,
                            CreatedByName = "InitialCreated",
                            CreatedDate = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(5045),
                            Description = "JavaScript dili ile ilgili makaleler.",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreated",
                            ModifiedDate = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(5046),
                            Name = "JavaScript",
                        ...
                        new
                        {
                            Id = 3,
                            CreatedByName = "InitialCreated",
                            CreatedDate = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(5049),
                            Description = "React Js ile ilgili makaleler.",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreated",
                            ModifiedDate = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(5050),
                            Name = "React Js",
            ...
            modelBuilder.Entity("BlogApp.Entities.Concrete.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedByName = "InitialCreated",
                            CreatedDate = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(9317),
                            Description = "Admin rolü, tüm haklara sahiptir.",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreated",
                            ModifiedDate = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(9318),
                            Name = "Admin",
                        ...
                        new
                        {
                            Id = 2,
                            CreatedByName = "InitialCreated",
                            CreatedDate = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(9322),
                            Description = "User rolü, kısıtlı haklara sahiptir.",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreated",
                            ModifiedDate = new DateTime(2022, 11, 28, 17, 56, 53, 18, DateTimeKind.Local).AddTicks(9323),
                            Name = "User",
            ...
            modelBuilder.Entity("BlogApp.Entities.Concrete.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedByName = "InitialCreated",
                            CreatedDate = new DateTime(2022, 11, 28, 17, 56, 53, 19, DateTimeKind.Local).AddTicks(3977),
                            ...
                            LastName = "Gezen",
                            ModifiedByName = "InitialCreated",
                            ModifiedDate = new DateTime(2022, 11, 28, 17, 56, 53, 19, DateTimeKind.Local).AddTicks(3978),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedByName = "InitialCreated",
                            CreatedDate = new DateTime(2022, 11, 28, 17, 56, 53, 19, DateTimeKind.Local).AddTicks(4000),
                            Description = "İlk admin kullancısı",
                            ...
                            LastName = "Onan",
                            ModifiedByName = "InitialCreated",
                            ModifiedDate = new DateTime(2022, 11, 28, 17, 56, 53, 19, DateTimeKind.Local).AddTicks(4001),
