...
namespace BlogApp.Services.Concrete
{
    public class ArticleManager : IArticleService
    {
        ...
        public async Task<IResult> Add(ArticleAddDto articleAddDto, string createdByName)
        {
            ...
            #region Açıklamalar
            //User Id'yi şimdilik elle veriyoruz. Login işlemlerini tamamladığımızda burayı değiştireceğiz.
            //Eğer entity base içinde Created Date için default değer vermemiş olsaydık böyle olabilirdi. Bunun ikinci bir yolu da Profile içinden bu değeri vermektir.
