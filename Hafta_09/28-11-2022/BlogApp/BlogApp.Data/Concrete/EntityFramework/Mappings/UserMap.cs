...
namespace BlogApp.Data.Concrete.EntityFramework.Mappings
{
    public class UserMap : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.HasIndex(u => u.Email).IsUnique();//Benzersiz olmasını sağladık başka aynısından olamaz dedik! 
          
            builder.Property(u => u.UserName).IsRequired().HasMaxLength(20);
            builder.HasIndex(u => u.UserName).IsUnique();//Benzersiz olmasını sağladık başka aynısından olamaz dedik! 
            ...
            builder.HasData(
                new User
                {
                    ...
                    Description = "İlk admin kullancısı",
                    ...
                    PasswordHash = Encoding.ASCII.GetBytes("200820e3227815ed1756a6b531e7e0d2")//qwe123 şifresinin hash hali
                },
                  new User
                  {
                      Id = 2,
                      ...
                      PasswordHash = Encoding.ASCII.GetBytes("46f94c8de14fb36680850768ff1b7f2a")//123qwe şifresinin hash hali
                  }
                ) ;
