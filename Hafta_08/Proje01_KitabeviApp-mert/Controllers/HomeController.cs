...
public class HomeController : Controller
{
    ...
    {
        context.Yazarlar.Add(yazar);// En baştaki kategori tablosuna ekledik
        context.SaveChanges();// Veri tabanına kaydetti.
        return RedirectToAction("YazarListesi");//Kategori Listesi action'a geri yolladı. Yani kayıttan sonra katogeri listesi gözükecek.
    }
    ...
    public IActionResult KategoriGuncelle(int id)
    {
        ...
        Kategori kategori = context.Kategoriler.Find(id);//ilgili entity(kategori)'deki primary key de arama yapar yani bizim PK'mız id olduğu için bunu kullandık.
