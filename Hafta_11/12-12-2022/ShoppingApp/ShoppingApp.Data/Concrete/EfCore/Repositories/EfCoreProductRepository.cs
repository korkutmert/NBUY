...
namespace ShoppingApp.Data.Concrete.EfCore.Repositories
{
    public class EfCoreProductRepository : EfCoreGenericRepository<Product>, IProductRepository
    {
        ...
        {
            //önce product kaydı yapacağız böylece ProductId olacak sonra da bu ProductId'yi kullanarak ProductCategory kaydını/kayıtlarını yapacagız.
        ...
        public async Task<Product> GetProductWithCategories(int id)
        {
            return await ShopAppContext
             .Products
             .Where(p=>p.Id==id)// ilgili Id li kaydı bul
             .Include(p => p.ProductCategories)
             .ThenInclude(pc => pc.Category)
             .FirstOrDefaultAsync();
        }
